...
class Cpu(val memory: Memory, val isDebug: Boolean = false) {
    ...
    private val cbInstructions: Array<(() -> Unit)?> = opcodeTable(
        ...
        0x86u to { resetBitHl(0) },
        0x87u to { a = resetBitRegister(0, a) },
        0x88u to { b = resetBitRegister(1, b) },
        0x89u to { c = resetBitRegister(1, c) },
        0x8Au to { d = resetBitRegister(1, d) },
        0x8Bu to { e = resetBitRegister(1, e) },
        0x8Cu to { h = resetBitRegister(1, h) },
        0x8Du to { l = resetBitRegister(1, l) },
        0x8Eu to { resetBitHl(1) },
        0x8Fu to { a = resetBitRegister(1, a) },
        0x90u to { b = resetBitRegister(2, b) },
        0x91u to { c = resetBitRegister(2, c) },
        0x92u to { d = resetBitRegister(2, d) },
        0x93u to { e = resetBitRegister(2, e) },
        0x94u to { h = resetBitRegister(2, h) },
        0x95u to { l = resetBitRegister(2, l) },
        0x96u to { resetBitHl(2) },
        0x97u to { a = resetBitRegister(2, a) },
        0x98u to { b = resetBitRegister(3, b) },
        0x99u to { c = resetBitRegister(3, c) },
        0x9Au to { d = resetBitRegister(3, d) },
        0x9Bu to { e = resetBitRegister(3, e) },
        0x9Cu to { h = resetBitRegister(3, h) },
        0x9Du to { l = resetBitRegister(3, l) },
        0x9Eu to { resetBitHl(3) },
        0x9Fu to { a = resetBitRegister(3, a) },
        0xA0u to { b = resetBitRegister(4, b) },
        0xA1u to { c = resetBitRegister(4, c) },
        0xA2u to { d = resetBitRegister(4, d) },
        0xA3u to { e = resetBitRegister(4, e) },
        0xA4u to { h = resetBitRegister(4, h) },
        0xA5u to { l = resetBitRegister(4, l) },
        0xA6u to { resetBitHl(4) },
        0xA7u to { a = resetBitRegister(4, a) },
        0xA8u to { b = resetBitRegister(5, b) },
        0xA9u to { c = resetBitRegister(5, c) },
        0xAAu to { d = resetBitRegister(5, d) },
        0xABu to { e = resetBitRegister(5, e) },
        0xACu to { h = resetBitRegister(5, h) },
        0xADu to { l = resetBitRegister(5, l) },
        0xAEu to { resetBitHl(5) },
        0xAFu to { a = resetBitRegister(5, a) },
        0xB0u to { b = resetBitRegister(6, b) },
        0xB1u to { c = resetBitRegister(6, c) },
        0xB2u to { d = resetBitRegister(6, d) },
        0xB3u to { e = resetBitRegister(6, e) },
        0xB4u to { h = resetBitRegister(6, h) },
        0xB5u to { l = resetBitRegister(6, l) },
        0xB6u to { resetBitHl(6) },
        0xB7u to { a = resetBitRegister(6, a) },
        0xB8u to { b = resetBitRegister(7, b) },
        0xB9u to { c = resetBitRegister(7, c) },
        0xBAu to { d = resetBitRegister(7, d) },
        0xBBu to { e = resetBitRegister(7, e) },
        0xBCu to { h = resetBitRegister(7, h) },
        0xBDu to { l = resetBitRegister(7, l) },
        0xBEu to { resetBitHl(7) },
        0xBFu to { a = resetBitRegister(7, a) },
        0xC0u to { b = setBitRegister(0, b) },
        0xC1u to { c = setBitRegister(0, c) },
        0xC2u to { d = setBitRegister(0, d) },
        0xC3u to { e = setBitRegister(0, e) },
        0xC4u to { h = setBitRegister(0, h) },
        0xC5u to { l = setBitRegister(0, l) },
        0xC6u to { setBitHl(0) },
        0xC7u to { a = setBitRegister(0, a) },
        0xC8u to { b = setBitRegister(1, b) },
        0xC9u to { c = setBitRegister(1, c) },
        0xCAu to { d = setBitRegister(1, d) },
        0xCBu to { e = setBitRegister(1, e) },
        0xCCu to { h = setBitRegister(1, h) },
        0xCDu to { l = setBitRegister(1, l) },
        0xCEu to { setBitHl(1) },
        0xCFu to { a = setBitRegister(1, a) },
        0xD0u to { b = setBitRegister(2, b) },
        0xD1u to { c = setBitRegister(2, c) },
        0xD2u to { d = setBitRegister(2, d) },
        0xD3u to { e = setBitRegister(2, e) },
        0xD4u to { h = setBitRegister(2, h) },
        0xD5u to { l = setBitRegister(2, l) },
        0xD6u to { setBitHl(2) },
        0xD7u to { a = setBitRegister(2, a) },
        0xD8u to { b = setBitRegister(3, b) },
        0xD9u to { c = setBitRegister(3, c) },
        0xDAu to { d = setBitRegister(3, d) },
        0xDBu to { e = setBitRegister(3, e) },
        0xDCu to { h = setBitRegister(3, h) },
        0xDDu to { l = setBitRegister(3, l) },
        0xDEu to { setBitHl(3) },
        0xDFu to { a = setBitRegister(3, a) },
        0xE0u to { b = setBitRegister(4, b) },
        0xE1u to { c = setBitRegister(4, c) },
        0xE2u to { d = setBitRegister(4, d) },
        0xE3u to { e = setBitRegister(4, e) },
        0xE4u to { h = setBitRegister(4, h) },
        0xE5u to { l = setBitRegister(4, l) },
        0xE6u to { setBitHl(4) },
        0xE7u to { a = setBitRegister(4, a) },
        0xE8u to { b = setBitRegister(5, b) },
        0xE9u to { c = setBitRegister(5, c) },
        0xEAu to { d = setBitRegister(5, d) },
        0xEBu to { e = setBitRegister(5, e) },
        0xECu to { h = setBitRegister(5, h) },
        0xEDu to { l = setBitRegister(5, l) },
        0xEEu to { setBitHl(5) },
        0xEFu to { a = setBitRegister(5, a) },
        0xF0u to { b = setBitRegister(6, b) },
        0xF1u to { c = setBitRegister(6, c) },
        0xF2u to { d = setBitRegister(6, d) },
        0xF3u to { e = setBitRegister(6, e) },
        0xF4u to { h = setBitRegister(6, h) },
        0xF5u to { l = setBitRegister(6, l) },
        0xF6u to { setBitHl(6) },
        0xF7u to { a = setBitRegister(6, a) },
        0xF8u to { b = setBitRegister(7, b) },
        0xF9u to { c = setBitRegister(7, c) },
        0xFAu to { d = setBitRegister(7, d) },
        0xFBu to { e = setBitRegister(7, e) },
        0xFCu to { h = setBitRegister(7, h) },
        0xFDu to { l = setBitRegister(7, l) },
        0xFEu to { setBitHl(7) },
